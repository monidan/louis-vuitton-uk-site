<template>
  <footer class="lv__footer">
    <page-wrapper class="lv__footer__wrapper">
      <div class="lv__footer__top">
        <div class="lv__footer__top__logo">
          <svg
      ...
      <div class="lv__footer__bottom">
        <div class="lv__footer__bottom__navigation">
          <nav>
            <ul>
              <li>
                <a href="#">
                  <img src="../assets/flag.svg" alt="Ukraine" />
                  <p>{{ country }}</p>
                </a>
              </li>
              <li>
